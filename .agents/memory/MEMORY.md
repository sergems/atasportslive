...
- [TanStack Query select-as-setState anti-pattern](too-many-rerenders-pattern.md) — calling setState in a select callback runs during render and causes "Too many re-renders"
