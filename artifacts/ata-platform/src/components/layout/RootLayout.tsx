...
export function RootLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="relative flex min-h-[100dvh] flex-col bg-background text-foreground">
      <Navbar />
      <main className={`flex-1 w-full pb-24 md:pb-8 ${location === '/' ? '' : 'max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8'}`}>
      ...
      <footer className={`mb-16 md:mb-0 mt-16 border-t border-border/40 bg-primary/30 ${location === '/' ? '' : 'hidden md:block'}`}>
