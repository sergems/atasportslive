...
const navItems = [
  { href: '/admin',                     label: 'Dashboard',           icon: LayoutDashboard, exact: true, minLevel: 3 },
  ...
  { href: '/admin/games',               label: 'Predictions',         icon: Trophy, settleBadge: true,     minLevel: 2 },
  { href: '/admin/bets',                label: 'Manage Predictions',  icon: Swords,                        minLevel: 2 },
  ...
  { href: '/admin/influencers',         label: 'Influencers',         icon: Star,                          minLevel: 3 },
  { href: '/admin/promotions',          label: 'Promotions',          icon: Gift,                          minLevel: 3 },
  { href: '/admin/vouchers',            label: 'Vouchers',            icon: Ticket,                        minLevel: 3 },
  { href: '/admin/reports',             label: 'Reports',             icon: BarChart2,                     minLevel: 3 },
  { href: '/admin/sessions',            label: 'Sessions',            icon: MonitorSmartphone,              minLevel: 3 },
  { href: '/admin/settings',            label: 'Settings',            icon: Settings,                      minLevel: 3 },
];
